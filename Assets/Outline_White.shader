...
Shader "Outlined/UltimateOutlineShadows"
{
	Properties
	{
		...
		_FirstOutlineColor("First Outline color", Color) = (1, 1, 1, 1) // White color
		_FirstOutlineWidth("First Outline width", Range(0.0, 2.0)) = 0.15

		_SecondOutlineColor("Second Outline color", Color) = (0.7, 0.7, 1, 1) // Light Blue color
